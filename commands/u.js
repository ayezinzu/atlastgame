...
if(mydust < 5){
  return message.reply(`🔴 You don\`t have enough dust to upgrade this card. Collect atleast 5 dust by burning your cards. 🔴`)
}

      const newEmbed = new Discord.MessageEmbed().setTitle('Card upgrade confirmation')
      newEmbed.addField(` \u200B`, `***<@${userid}> you are about to upgrade \`\`${cardname}\`\` and spell it with more power! you will be charged \`\`5\`\` dust for it. Confirm this upgrade by reacting to \`\`👍\`\`. You have 10 seconds.*** `, )
...
console.log("this code was executed");
                 const newEmbed = new Discord.MessageEmbed().setTitle('🔴 You have reached maximum upgrades on this card 🔴')
...
console.log("HEWLOOO");
                  ...
                  newscore = cardscore + upgrade
                        ...
                        okEmbed.addField(` \u200B`, ` **<@${userid}> just upgraded \`\`${cardname}\`\`  and increased the cardscore to  \`\`${ item.cardscore}\`\` points** `, )
