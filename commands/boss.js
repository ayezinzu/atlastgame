...
exports.run = async (client, message, args) => {
	...
	const bosscard = await Addboss.findOne().skip(random12).exec();
	...
	await message.channel.send(`\`\`${bosscard.cardname} (Level-${bosscard.difficulty}) - ${bosscard.element}\`\``);
	await message.channel.send(`Enter \`\`CARDID\`\` to enter a card in the battle !`);
	...
	collector.on('end', async collected => {
		...
		if (
			...
			var randomcard = cardnamearray[Math.floor(Math.random() * cardnamearray.length)];
			var randomcard1 = cardnamearray[Math.floor(Math.random() * cardnamearray.length)];
			var slursarry = [
			...
			setTimeout(() => {
				...
				randomcard1 = cardnamearray[Math.floor(Math.random() * cardnamearray.length)];
				var slursarry = [
					`\`\`${randomcard}\`\` took a heavy hit! Ouch!`,
					`\`\`${randomcard}\`\` is leading the battle!`,
					`\`\`${randomcard}\`\` isn't giving up!`,
				...
				setTimeout(() => {
					...
					setTimeout(() => {
						...
						setTimeout(() => {
							...
							randomslur4 = slursarry[Math.floor(Math.random() * slursarry.length)];
							...
							setTimeout(() => {
								...
								randomslur5 = slursarry[Math.floor(Math.random() * slursarry.length)];
								...
								setTimeout(() => {
									...
									randomslur6 = slursarry[Math.floor(Math.random() * slursarry.length)];
									...
									setTimeout(() => {
										...
										randomslur7 = slursarry[Math.floor(Math.random() * slursarry.length)];
										...
										setTimeout(() => {
											...
											randomslur8 = slursarry[Math.floor(Math.random() * slursarry.length)];
					...
					if (bossdifficulty === 1) {
						...
						for (let itemone of cardsarray) {
							...
							if (reward === 2) {
								...
								winmsg.push(`<@${itemone.cardowner}> won \`\`${reward} dust\`\` from the boss fight `);
							...
							if (reward === '1uc') {
								...
								Addcard.find({
									...
									.then(result => {
										...
										finaluncommoncard =
											uncommoncardarray[Math.floor(Math.random() * uncommoncardarray.length)];
										carduc = [
											'cardname',
											'cardtype',
											'cardscore',
										...
										thisistheguy
											...
											.catch(err => console.log(err));
										winmsg.push(
											`<@${itemone.cardowner}> won \`\`${carduc.cardname} - (${carduc.cardtype}) - ${carduc.element}\`\` from the boss fight `
										);
										resultEmbed.addField(`Rewards`, winmsg);
										//h
									})
							...
							if (reward === '1c') {
								...
								Addcard.find({
									...
									.then(result => {
										...
										var upgrade = 1;
										finalcommoncard =
											commoncardarray[Math.floor(Math.random() * commoncardarray.length)];
										cardc = [
											'cardname',
											'cardtype',
											'cardscore',
										...
										thisistheguy
											...
											.catch(err => console.log(err));
										winmsg.push(
											`<@${itemone.cardowner}> won \`\`${cardcitname} - (${cardittype}) - ${cardc.element}\`\` from the boss fight `
										);
										resultEmbed.addField(`Rewards`, winmsg);
										//h
									})
								...
								Addcard.find({
									...
									.then(result => {
										...
										thisistheguy
											...
											.catch(err => console.log(err));
										winmsg.push(
											`\n <@${itemone.cardowner}> won \`\`${cardcc.cardname} - (${cardcc.cardtype}) - ${cardcc.element}\`\` \n \`\`${card1.cardname} - (${card1.cardtype}) - ${card1.element}\`\` from the boss fight`
										);
								...
								Addcard.find({
									...
									.then(result => {
										...
										thisistheguy
											...
											.catch(err => console.log(err));
										winmsg.push(
											`\n <@${itemone.cardowner}> won \`\`${cardc.cardname} - (${cardc.cardtype}) - ${cardc.element}\`\` \`\`${card1.cardname} - (${card1.cardtype}) - ${card1.element}\`\` \`\`${card2.cardname} - (${card2.cardtype}) - ${card2.element}\`\` from the boss fight`
										);
								...
								Addcard.find({
									...
									.then(result => {
										...
										thisistheguy
											...
											.catch(err => console.log(err));
										winmsg.push(
											`<@${itemone.cardowner}> won \`\`${carditname} - (${cardittype}) - ${cardc.element}\`\` from the boss fight `
										);
										resultEmbed.addField(`Rewards`, winmsg);
										//h
									})
								...
								Addcard.find({
									...
									.then(result => {
										...
										thisistheguy
											...
											.catch(err => console.log(err));
										winmsg.push(
											`\n <@${itemone.cardowner}> won \`\`${cardcc.cardname} - (${cardcc.cardtype}) - ${cardcc.element}\`\` \`\`${card1.cardname} - (${card1.cardtype}) - ${card1.element}\`\` from the boss fight`
										);
								...
								Addcard.find({
									...
									.then(result => {
										...
										thisistheguy
											...
											.catch(err => console.log(err));
										winmsg.push(
											`<@${itemone.cardowner}> won \`\`${carduc.cardname} - (${carduc.cardtype}) - ${carduc.element}\`\` \`\`${carduc1.cardname} - (${carduc1.cardtype}) - ${carduc1.element}\`\`from the boss fight `
										);
										resultEmbed.addField(`Rewards`, winmsg);
										//h
									})
								...
								Addcard.find({
									...
									.then(result => {
										...
										thisistheguy
											...
											.catch(err => console.log(err));
										winmsg.push(
											`<@${itemone.cardowner}> won \`\`${cardr.cardname} - (${cardr.cardtype}) - ${cardr.element}\`\` from the boss fight `
										);
										resultEmbed.addField(`Rewards`, winmsg);
									})
									.catch(err => console.log(err));
								...
								Addcard.find({
									...
									.then(result => {
										...
										thisistheguy
											...
											.catch(err => console.log(err));
										winmsg.push(
											`<@${itemone.cardowner}> won \`\`${cardr.cardname} - (${cardr.cardtype}) - ${cardr.element}\`\` \`\`${cardr1.cardname} - (${cardr1.cardtype}) - ${cardr1.element}\`\` from the boss fight `
										);
										resultEmbed.addField(`Rewards`, winmsg);
										//h
									})
								...
								Addcard.find({
									...
									.then(result => {
										...
										thisistheguy
											...
											.catch(err => console.log(err));
										winmsg.push(
											`<@${itemone.cardowner}> won \`\`${carde.cardname} - (${carde.cardtype}) - ${carde.element}\`\` from the boss fight `
										);
										resultEmbed.addField(`Rewards`, winmsg);
										//h
									})
		...
		setTimeout(async () => {
			if (num < winchance) {
				...
				finalEmbed.addField(
					`Result :`,
					`***Oh no! Players were unable to defeat the raid boss. Better luck next time !***`
				);
				finalEmbed.setColor(`#FF0000`);
				message.channel.send(finalEmbed);
			}
